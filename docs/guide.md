...
A fejlesztői útmutató, illetve maga a LogB is fejlesztés alatt áll, verziószám nélküli. A rendszer jelenleg nem használható kritikus feladatok ellátására.
:::
